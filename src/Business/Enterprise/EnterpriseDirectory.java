...
public class EnterpriseDirectory {
    ...
    public Enterprise createAndAddEnterprise(String name,Enterprise.EnterpriseType type){
        ...
        if(type==Enterprise.EnterpriseType.EventPlanner){
            enterprise=new EventPlannerEnterprise(name);
            enterpriseList.add(enterprise);
        }
        return enterprise;
    }
    
    public boolean checkIfEnterpriseNameIsUnique(String name, ArrayList<Enterprise> e){
